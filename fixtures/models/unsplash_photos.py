...
@dataclass
class Photos:
    balloons_over_plain: UnsplashPhoto
...
def create_unsplash_photos() -> Photos:
    balloons_over_plain, _ = UnsplashPhoto.objects.get_or_create(
        id="dkDqDm7kR_U",
        defaults={
            "regular_url": "https://images.unsplash.com/photo-1575351881847-b3bf188d9d0a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyNTkxMDh8MHwxfHJhbmRvbXx8fHx8fHx8fDE2MzQ1NTgwNjI&ixlib=rb-1.2.1&q=80&w=1080",
            "small_url": "https://images.unsplash.com/photo-1575351881847-b3bf188d9d0a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyNTkxMDh8MHwxfHJhbmRvbXx8fHx8fHx8fDE2MzQ1NTgwNjI&ixlib=rb-1.2.1&q=80&w=400",
            "author_name": "Cinthia Aguilar",
            "author_url": "https://unsplash.com/@hello_cinthia",
        },
    )
    ...
    english_flag, _ = UnsplashPhoto.objects.get_or_create(
        id="C713D7KSkaY",
        defaults={
            "regular_url": "https://images.unsplash.com/photo-1603989872628-7880d83bb581?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyNTkxMDh8MHwxfGNvbGxlY3Rpb258MXxmbHYzSk96TklDa3x8fHx8Mnx8MTYzMzU1MDUwMg&ixlib=rb-1.2.1&q=80&w=1080",
            "small_url": "https://images.unsplash.com/photo-1603989872628-7880d83bb581?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyNTkxMDh8MHwxfGNvbGxlY3Rpb258MXxmbHYzSk96TklDa3x8fHx8Mnx8MTYzMzU1MDUwMg&ixlib=rb-1.2.1&q=80&w=400",
            "author_name": "Sigmund",
